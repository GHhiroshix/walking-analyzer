    ...
    return (
      <div style={wrap}><GlassOrbs/><div style={maxW}><div style={{paddingTop:32}}>
        ...
        <div style={{display:"flex",gap:10,marginTop:20}}>
          <button onClick={()=>{document.getElementById("print-report").style.display="block";window.print();document.getElementById("print-report").style.display="none";}} style={{flex:1,padding:"13px",background:`linear-gradient(135deg,${C.accent},${C.accentDim})`,border:"none",borderRadius:12,color:C.bgSolid,fontSize:14,fontWeight:700,cursor:"pointer",fontFamily:C.font,boxShadow:`0 4px 20px ${C.accent}33`}}>🖨️ 印刷 / PDF保存</button>
        </div>
        ...
        <div id="print-report" style={{display:"none"}}>
          ...
          `}</style>
          <div style={{fontFamily:"'Kosugi Maru', sans-serif",color:"#111",padding:"0",maxWidth:700,margin:"0 auto"}}>
